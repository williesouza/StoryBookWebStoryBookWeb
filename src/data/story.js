...
export const story = [
    ...
    {
        id: 5,
        title: "Configuração da ETA: Tipos de Coleta",
        text: "Aqui, o Guardião define quais tipos de coleta são relevantes para a unidade em questão (ex: ETA ALTO DO CÉU). Ele visualiza a lista de 'TIPO DE COLETA' disponíveis (ÁGUA BRUTA, ÁGUA DECANTADA, etc.).",
        image: placeholder,
        alt: "Detalhamento da configuração da unidade, mostrando tipos de coleta e o status EM USO."
    },
    {
        id: 6,
        title: "Ativando o Tipo de Coleta",
        text: "Para um tipo de coleta aparecer no App Mobile de campo, ele deve ser marcado como 'EM USO'. O Guardião seleciona o tipo (ex: ÁGUA BRUTA II) e clica no campo para ativá-lo com a marca de seleção.",
        image: placeholder,
        alt: "Tela mostrando a seleção de um Tipo de Coleta (ÁGUA BRUTA II) para ser marcado como EM USO."
    },
    {
        id: 7,
        title: "Marcando 'Em Uso' para o Mobile",
        text: "A marcação é a ponte entre o sistema Web e o App. Ao finalizar as seleções, o Guardião garante que apenas os tipos de coleta relevantes para a ETA selecionada (ETA ALTO DO CÉU) estarão disponíveis para o técnico em campo.",
        image: placeholder,
        alt: "Tela final de Configuração de Unidade, destacando a marca de seleção EM USO e o botão SALVAR."
    },
    {
        id: 8,
    ...
    },
    {
        ...
        text: "Para controlar o acesso, o Guardião navega para 'ADMINISTRAÇÃO' > 'UNIDADE x USUÁRIO'. Nesta tela, ele configura quais Unidades Operacionais um determinado usuário (ex: Danilo Souza) pode acessar.",
        image: placeholder,
        alt: "Tela de Configuração do Usuário x Unidade Operacional, mostrando a lista de unidades que Danilo Souza tem acesso."
    },
    {
        id: 10,
    ...
    },
    {
        ...
        text: "Neste formulário, o Guardião informa a 'UNIDADE OPERACIONAL', e os resultados para 'COLIFORMES TOTAIS' e 'ESCHERICHIA COLI', selecionando 'AUSENTE' ou 'PRESENTE' em menus suspensos.",
        image: placeholder,
        alt: "Detalhamento da inserção de Coliformes Totais e Escherichia Coli (PRESENTE ou AUSENTE)."
    },
    {
        id: 14,
        title: "Datas de Coleta e Resultado",
        text: "O Guardião insere a 'DT COLETA' e a 'DT RESULTADO' usando o seletor de calendário, garantindo o registro temporal exato da amostra e sua análise laboratorial.",
        image: placeholder,
        alt: "Tela de lançamento com o pop-up de calendário aberto para seleção da Data da Coleta."
    },
    {
        id: 15,
        title: "Inserção dos Parâmetros Físico-Químicos",
        text: "Além da bacteriologia, os parâmetros físico-químicos são essenciais. O Guardião insere os dados de 'COR', 'PH', 'TURBIDEZ' e 'CLORO', e seleciona o 'TIPO DE COLETA' (ex: ÁGUA TRATADA) para finalizar o registro.",
        image: placeholder,
        alt: "Tela com dados de Cor, pH, Turbidez, Cloro preenchidos e a seleção do Tipo de Coleta."
    },
    {
        id: 16,
